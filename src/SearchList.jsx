        ...
        <>
            ...
            <div className='container results'>
                ...
                {searchResults.map(item => {
                    return <SearchResult key={crypto.randomUUID()} id={item.id} alternate_name={item.alternate_name} name={item.name} address={item.address} placename={item.placename} current_status={item.current_status} amenities={item.amenities} description={item.description} e_coli={item.e_coli} int_ent={item.int_ent} lat={item.lat} lon={item.lon}/>
                })}
            </div>
        </>
    )
